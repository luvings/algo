...
int main(int argc, char *argv[])
{
	...
	Put(map, "1111", "asdfasdfds11");
	Put(map, "2222", "asdfasdfds22");
	Put(map, "3333", "asdfasdfds33");
	Put(map, "4545", "asdfasdfds45");
	Put(map, "4444", "asdfasdfds44");
	Put(map, "5555", "asdfasdfds55");
	Put(map, "5555", "ppppppp66");
